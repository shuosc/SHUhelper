<template>
  ...
  <x-header slot="header" :left-options="{showBack:$route.path!='/' && $route.path!='/my' }" style="width:100%;position:absolute;left:0;top:0;z-index:100;">SHUhelper 2.0 Pre
  ...
  <transition name="fade">
    <router-view></router-view>
     ...
     <tabbar>
      ...
      <popup v-model="showLoginForm" is-transparent height="270px">
      <div class="popup" >
